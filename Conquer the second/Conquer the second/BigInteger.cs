...
public class BigInteger
{
    ...
    {
        int firstLengthE = _numbers.Length + 1;
        int secondLengthE = another._numbers.Length + 1;
        int firstArrayLength = _numbers.Length - 1;
        int secondArrayLength = another._numbers.Length - 1;
        bool borrow = false; // флаг позикового додатку
        ...
        while (firstArrayLength != -1 && secondArrayLength != -1)
        {
            if (firstArrayLength >= secondArrayLength)
            {
                ...
                if (difference >= 0)
                {
                    _numbers[firstArrayLength] = difference;
                    borrow = false;
                }
                else
                {
                    _numbers[firstArrayLength] = difference + 10;
                    borrow = true;
                }
            }
            else
            {
                ...
                if (difference >= 0)
                {
                    another._numbers[secondArrayLength] = difference;
                    borrow = false;
                }
                else
                {
                    another._numbers[secondArrayLength] = difference + 10;
                    borrow = true;
                }
            }
